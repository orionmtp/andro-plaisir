...
// Aucun champ n'est vide, on peut enregistrer dans la table
{
	...
	$db = mysqli_connect( $adresse, $login, $password,$database)  or die('Erreur de connexion' .mysqli_error($db));
		...
		$sql="select nom,prenom,matricule,bio,valid from personnage where rfid='$rfid'";
...
echo '<p style="color:#FF0000">ID INVALIDE</p><br>';
	...
	echo '<form action="scan_cop.php" method=POST><input type="hidden" name="id" value="'.$id.'"><input type="submit" value="retour scan"></form>';
	echo '</body>';
